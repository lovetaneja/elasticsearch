...
/**
 * @author love_taneja
 * This is a Constants file for Error Codes
 */
public class ErrorCodes {
    ...
    public static final int REST_CALL_EXCEPTION_CODE = 2003;

    public static final int PARSE_RESPONSE_JSON_SYNTAX_EXCEPTION_CODE = 2004;

    public static final int PARSE_RESPONSE_JSON_IO_EXCEPTION_CODE = 2005;

    public static final int PARSE_RESPONSE_JSON_PARSE_EXCEPTION_CODE = 2006;

    public static final int SEARCH_RESPONSE_NULL_ERROR_CODE = 2007;
