package com.personalcapital.searchplans.dto;
...
public class ElasticSearchResponseDTO {
    ...
    @Expose
    private String sponsDefLocForeignAddress1;

    @SerializedName("TYPE_WELFARE_BNFT_CODE")
    @Expose
    private String typeWelfareBnftCode;

    @SerializedName("NUM_SCH_A_ATTACHED_CNT")
    @Expose
    private String numSchAAttachedCnt;

    @SerializedName("PREPARER_FIRM_NAME")
    @Expose
    private String preparerFirmName;

    @SerializedName("PREPARER_FOREIGN_PROV_STATE")
    @Expose
    private String preparerForeignProvState;

    @SerializedName("SPONS_DFE_MAIL_US_ZIP")
    @Expose
    private String sponsDefMailUsZip;

    @SerializedName("LAST_RPT_PLAN_NUM")
    @Expose
    private String lastRptPlanNum;

    @SerializedName("ADMIN_FOREIGN_CITY")
    @Expose
    private String adminForeignCity;

    @SerializedName("SPONS_SIGNED_NAME")
    @Expose
    private String sponsSignedName;

    @SerializedName("ADMIN_FOREIGN_ADDRESS2")
    @Expose
    private String adminForeignAddress2;

    @SerializedName("SCH_R_ATTACHED_IND")
    @Expose
    private String schRAttachedInd;

    @SerializedName("PREPARER_FOREIGN_POSTAL_CD")
    @Expose
    private String preparerForeignPostalCd;

    @SerializedName("SPONS_DFE_MAIL_US_CITY")
    @Expose
    private String sponsDefMailUsCity;

    @SerializedName("SPONS_DFE_PN")
    @Expose
    private String sponsDefPn;

    @SerializedName("SEP_PARTCP_PARTL_VSTD_CNT")
    @Expose
    private String sepPartcpPartlVstdCnt;

    @SerializedName("SCH_SB_ATTACHED_IND")
    @Expose
    private String schSbAttachedInd;

    @SerializedName("ADMIN_NAME_SAME_SPON_IND")
    @Expose
    private String adminNameSameSponInd;

    @SerializedName("SPONS_DFE_LOC_FOREIGN_ADDRESS2")
    @Expose
    private String sponsDefLocForeignAddress2;

    @SerializedName("TYPE_DFE_PLAN_ENTITY_CD")
    @Expose
    private String typeDefPlanEntityCd;

    @SerializedName("SPONS_SIGNED_DATE")
    @Expose
    private String sponsSignedDate;

    @SerializedName("SPONS_DFE_MAIL_FOREIGN_CNTRY")
    @Expose
    private String sponsDefMailForignCntry;

    @SerializedName("ADMIN_US_STATE")
    @Expose
    private String adminUsState;

    @SerializedName("ADMIN_FOREIGN_POSTAL_CD")
    @Expose
    private String adminForeignPostalCd;

    @SerializedName("DFE_SIGNED_NAME")
    @Expose
    private String defSignedName;

    @SerializedName("DFVC_PROGRAM_IND")
    @Expose
    private String dfvcProgramInd;

    @SerializedName("SPONS_DFE_EIN")
    @Expose
    private String sponsDefEin;

    @SerializedName("LAST_RPT_PLAN_NAME")
    @Expose
    private String lastRptPlanName;

    @SerializedName("ADMIN_MANUAL_SIGNED_DATE")
    @Expose
    ...
    @SerializedName("SPONS_DFE_MAIL_FOREIGN_ADDR1")
    @Expose
    private String sponsDefMailForeignAddr1;

    @SerializedName("EXT_SPECIAL_TEXT")
    @Expose
    private String extSpecialText;

    @SerializedName("FUNDING_TRUST_IND")
    @Expose
    private String fundingTrustInd;

    @SerializedName("FINAL_FILING_IND")
    @Expose
    private String finalFilingInd;

    @SerializedName("PARTCP_ACCOUNT_BAL_CNT")
    @Expose
    private String partcpAccountBalCnt;

    @SerializedName("FUNDING_GEN_ASSET_IND")
    @Expose
    private String fundingGenAssetInd;

    @SerializedName("SPONS_DFE_MAIL_FOREIGN_CITY")
    @Expose
    private String sponsDefMailForeignCity;

    @SerializedName("SPONS_DFE_MAIL_FOREIGN_ADDR2")
    @Expose
    private String getSponsDefLocForeignAddress2;

    @SerializedName("PREPARER_US_ADDRESS1")
    @Expose
    private String preparerUsAddress1;

    @SerializedName("SPONS_DFE_LOC_US_ZIP")
    @Expose
    private String sponsDefLocUsZip;

    @SerializedName("PREPARER_US_ADDRESS2")
    @Expose
    private String preparerUSAddress2;

    @SerializedName("FUNDING_SEC412_IND")
    @Expose
    private String fundingSec412Ind;

    @SerializedName("LAST_RPT_SPONS_NAME")
    @Expose
    private String lastRptSponsName;

    @SerializedName("BENEFIT_SEC412_IND")
    @Expose
    private String benefitSec412Ind;

    @SerializedName("FORM_PLAN_YEAR_BEGIN_DATE")
    @Expose
    private String formPlanYearBeginDate;

    @SerializedName("ADMIN_PHONE_NUM_FOREIGN")
    @Expose
    ...
    @SerializedName("ADMIN_US_CITY")
    @Expose
    private String adminUsCity;

    @SerializedName("M1_RECEIPT_CONFIRMATION_CODE")
    @Expose
    private String m1ReceiptConfirmationCode;

    @SerializedName("PREPARER_FOREIGN_ADDRESS1")
    @Expose
    private String preparerForeignAddress1;

    @SerializedName("BENEFIT_TRUST_IND")
    @Expose
    ...
    @SerializedName("SPONS_DFE_DBA_NAME")
    @Expose
    private String sponsDefDbaName;

    @SerializedName("SPONS_DFE_PHONE_NUM")
    @Expose
    private String sponsDefPhoneNum;

    @SerializedName("ADMIN_SIGNED_DATE")
    @Expose
    private String adminSignedDate;

    @SerializedName("BENEF_RCVG_BNFT_CNT")
    @Expose
    private String benefRcvgBnftCnt;

    @SerializedName("RTD_SEP_PARTCP_RCVG_CNT")
    @Expose
    private String rtdSepPartcpRcvgCnt;

    @SerializedName("SHORT_PLAN_YR_IND")
    @Expose
    private String shortPlanYrInd;

    @SerializedName("DFE_SIGNED_DATE")
    @Expose
    private String defSignedDate;

    @SerializedName("FUNDING_INSURANCE_IND")
    @Expose
    private String fundingInsuranceInd;

    @SerializedName("SCH_D_ATTACHED_IND")
    @Expose
    private String schDAttachedInd;

    @SerializedName("ADMIN_PHONE_NUM")
    @Expose
    private String adminPhoneNum;

    @SerializedName("ADMIN_US_ADDRESS2")
    @Expose
    private String adminUSAddress2;

    @SerializedName("SPONS_DFE_LOC_US_ADDRESS2")
    @Expose
    private String sponsDefLocUsAddress2;

    @SerializedName("ADMIN_US_ZIP")
    @Expose
    private String adminUsZip;

    @SerializedName("FILING_STATUS")
    @Expose
    private String filingStatus;

    @SerializedName("VALID_SPONSOR_SIGNATURE")
    @Expose
    private String validSponsorSignature;

    @SerializedName("SUBJ_M1_FILING_REQ_IND")
    @Expose
    private String subjM1FilingReqInd;

    @SerializedName("SPONS_MANUAL_SIGNED_DATE")
    @Expose
    private String sponsManualSignedDate;

    @SerializedName("TOT_PARTCP_BOY_CNT")
    @Expose
    private String totPartcpBoyCnt;

    @SerializedName("PREPARER_US_CITY")
    @Expose
    private String preparerUsCity;

    @SerializedName("ADMIN_MANUAL_SIGNED_NAME")
    @Expose
    private String adminManualSignedName;

    @SerializedName("SPONS_DFE_PHONE_NUM_FOREIGN")
    @Expose
    private String sponsDefPhoneNumForeign;

    @SerializedName("BENEFIT_INSURANCE_IND")
    @Expose
    private String benefitInsuranceInd;

    @SerializedName("SPONS_DFE_LOC_FORGN_POSTAL_CD")
    @Expose
    private String sponsDefLocForgnPostalCd;

    @SerializedName("@timestamp")
    @Expose
    private String timestamp;

    @SerializedName("SCH_G_ATTACHED_IND")
    @Expose
    private String schGAttachedInd;

    @SerializedName("ADMIN_ADDRESS_SAME_SPON_IND")
    @Expose
    private String adminAddressSameSponInd;

    @SerializedName("SPONS_DFE_MAIL_FORGN_PROV_ST")
    @Expose
    private String sponsDefMailForgnProvSt;

    @SerializedName("LAST_RPT_SPONS_EIN")
    @Expose
    private String lastRptSponsEin;

    @SerializedName("ADMIN_SIGNED_NAME")
    @Expose
    private String adminSignedName;

    @SerializedName("PLAN_EFF_DATE")
    @Expose
    private String planDefDate;

    @SerializedName("ADMIN_FOREIGN_CNTRY")
    @Expose
    private String adminForeignCntry;

    @SerializedName("SPONS_DFE_LOC_US_CITY")
    @Expose
    private String sponsDefLocUSCity;

    @SerializedName("CONTRIB_EMPLRS_CNT")
    @Expose
    private String contribEmplrsCnt;

    @SerializedName("SCH_H_ATTACHED_IND")
    @Expose
    private String schHAttachedInd;

    @SerializedName("ADMIN_FOREIGN_ADDRESS1")
    @Expose
    private String adminForeignAddress1;

    @SerializedName("PREPARER_PHONE_NUM")
    @Expose
    private String preparerPhoneNum;

    @SerializedName("ADMIN_US_ADDRESS1")
    @Expose
    ...
    @SerializedName("COLLECTIVE_BARGAIN_IND")
    @Expose
    private String collectiveBargainInd;

    @SerializedName("EXT_AUTOMATIC_IND")
    @Expose
    private String extAutomaticInd;

    @SerializedName("SPONS_DFE_MAIL_US_ADDRESS1")
    @Expose
    private String sponsDefMailUsAddress1;

    @SerializedName("SPONS_DFE_LOC_US_ADDRESS1")
    @Expose
    private String sponsDefLocUsAddress1;

    @SerializedName("DFE_MANUAL_SIGNED_DATE")
    @Expose
    private String defManualSignedDate;

    @SerializedName("FORM_TAX_PRD")
    @Expose
    private String formTaxPrd;

    @SerializedName("SPONS_DFE_LOC_FOREIGN_CNTRY")
    @Expose
    private String sponsDefLocForeignCntry;

    @SerializedName("SPONS_DFE_MAIL_US_STATE")
    @Expose
    private String sponsDefMailUsState;

    @SerializedName("RTD_SEP_PARTCP_FUT_CNT")
    @Expose
    private String rtdSepPartchFunCnt;

    @SerializedName("COMPLIANCE_M1_FILING_REQ_IND")
    @Expose
    private String complaineM1FilingReqInd;

    @SerializedName("PREPARER_FOREIGN_ADDRESS2")
    @Expose
    private String preparerForeignAddress2;

    @SerializedName("SPONS_MANUAL_SIGNED_NAME")
    @Expose
    private String sponsManualSignedName;

    @SerializedName("SUBTL_ACT_RTD_SEP_CNT")
    @Expose
    private String subtlActRtdSepCnt;

    @SerializedName("SCH_A_ATTACHED_IND")
    @Expose
    private String schAAttachedInd;

    @SerializedName("SPONS_DFE_CARE_OF_NAME")
    @Expose
    private String sponsDefCareOfName;

    @SerializedName("ACK_ID")
    @Expose
    private String ackId;

    @SerializedName("SCH_I_ATTACHED_IND")
    @Expose
    private String schIAttachedInd;

    @SerializedName("PREPARER_PHONE_NUM_FOREIGN")
    @Expose
    private String preparerPhoneNumForeign;

    @SerializedName("VALID_DFE_SIGNATURE")
    @Expose
    private String validDefSignature;

    @SerializedName("SCH_C_ATTACHED_IND")
    @Expose
    private String schCAttachedInd;

    @SerializedName("PREPARER_US_STATE")
    @Expose
    private String preparerUsState;

    @SerializedName("TYPE_PLAN_ENTITY_CD")
    @Expose
    private String typePlanEntiyCd;

    @SerializedName("SPONS_DFE_LOC_FORGN_PROV_ST")
    @Expose
    private String sponsDefLocForgnProvSt;

    @SerializedName("SCH_MB_ATTACHED_IND")
    @Expose
    private String schMBAttachedInd;

    @SerializedName("ADMIN_FOREIGN_PROV_STATE")
    @Expose
    private String adminForeignProvState;

    @SerializedName("VALID_ADMIN_SIGNATURE")
    @Expose
    private String validAdminSignature;

    @SerializedName("SPONSOR_DFE_NAME")
    @Expose
    private String sponsorDefName;

    @SerializedName("SPONS_DFE_MAIL_US_ADDRESS2")
    @Expose
    private String sponsDefMailUsAddress2;

    @SerializedName("TOT_ACT_PARTCP_BOY_CNT")
    @Expose
    private String totActPartcpBoyCnt;

    @SerializedName("F5558_APPLICATION_FILED_IND")
    @Expose
    private String f5558ApplicationFiledInd;

    @SerializedName("EXT_SPECIAL_IND")
    @Expose
    private String extSpecialInd;

    @SerializedName("AMENDED_IND")
    @Expose
    private String amendedInd;

    @SerializedName("ADMIN_CARE_OF_NAME")
    @Expose
    private String adminCareOfName;

    @SerializedName("INITIAL_FILING_IND")
    @Expose
    private String initialFilingInd;

    @SerializedName("TYPE_PENSION_BNFT_CODE")
    @Expose
    private String typePensionBnftCode;

    @SerializedName("PREPARER_FOREIGN_CITY")
    @Expose
    private String preparerForeignCity;

    @SerializedName("SPONS_DFE_LOC_US_STATE")
    @Expose
    private String sponsDefLocUSState;

    @SerializedName("PREPARER_FOREIGN_CNTRY")
    @Expose
    private String preparerForeignCntry;

    @SerializedName("BENEFIT_GEN_ASSET_IND")
    @Expose
    private String benefitGenAssetInd;

    @SerializedName("PREPARER_US_ZIP")
    @Expose
    ...
    @SerializedName("DFE_MANUAL_SIGNED_NAME")
    @Expose
    private String defManualSignedName;

    @SerializedName("SPONS_DFE_MAIL_FORGN_POSTAL_CD")
    @Expose
    private String sponsDefMailForgnPostalCd;

    @SerializedName("TOT_ACTIVE_PARTCP_CNT")
    @Expose
    ...
    @SerializedName("TOT_ACT_RTD_SEP_BENEF_CNT")
    @Expose
    private String totActRtdSepBenefCnt;

    @SerializedName("SPONS_DFE_LOC_FOREIGN_CITY")
    @Expose
    private String sponsdefLocForeignCity;

    @SerializedName("BUSINESS_CODE")
    @Expose
    private String businessCode;

    @SerializedName("ADMIN_EIN")
    @Expose
    private String adminEin;

    @SerializedName("ADMIN_NAME")
    @Expose
    private String adminName;

    public String getSponsDefLocForeignAddress1() {
        return sponsDefLocForeignAddress1;
    }

    public void setSponsDefLocForeignAddress1(String sponsDefLocForeignAddress1) {
        this.sponsDefLocForeignAddress1 = sponsDefLocForeignAddress1;
    }
    ...
    public String getSponsDefMailUsZip() {
        return sponsDefMailUsZip;
    }

    public void setSponsDefMailUsZip(String sponsDefMailUsZip) {
        this.sponsDefMailUsZip = sponsDefMailUsZip;
    }
    ...
    public String getAdminForeignAddress2() {
        return adminForeignAddress2;
    }

    public void setAdminForeignAddress2(String adminForeignAddress2) {
        this.adminForeignAddress2 = adminForeignAddress2;
    }
    ...
    public String getSponsDefMailUsCity() {
        return sponsDefMailUsCity;
    }

    public void setSponsDefMailUsCity(String sponsDefMailUsCity) {
        this.sponsDefMailUsCity = sponsDefMailUsCity;
    }

    public String getSponsDefPn() {
        return sponsDefPn;
    }

    public void setSponsDefPn(String sponsDefPn) {
        this.sponsDefPn = sponsDefPn;
    }
    ...
    public String getSponsDefLocForeignAddress2() {
        return sponsDefLocForeignAddress2;
    }

    public void setSponsDefLocForeignAddress2(String sponsDefLocForeignAddress2) {
        this.sponsDefLocForeignAddress2 = sponsDefLocForeignAddress2;
    }

    public String getTypeDefPlanEntityCd() {
        return typeDefPlanEntityCd;
    }

    public void setTypeDefPlanEntityCd(String typeDefPlanEntityCd) {
        this.typeDefPlanEntityCd = typeDefPlanEntityCd;
    }
    ...
    public String getSponsDefMailForignCntry() {
        return sponsDefMailForignCntry;
    }

    public void setSponsDefMailForignCntry(String sponsDefMailForignCntry) {
        this.sponsDefMailForignCntry = sponsDefMailForignCntry;
    }
    ...
    public String getDefSignedName() {
        return defSignedName;
    }

    public void setDefSignedName(String defSignedName) {
        this.defSignedName = defSignedName;
    }
    ...
    public String getSponsDefEin() {
        return sponsDefEin;
    }

    public void setSponsDefEin(String sponsDefEin) {
        this.sponsDefEin = sponsDefEin;
    }
    ...
    public String getSponsDefPhoneNumForeign() {
        return sponsDefPhoneNumForeign;
    }

    public void setSponsDefPhoneNumForeign(String sponsDefPhoneNumForeign) {
        this.sponsDefPhoneNumForeign = sponsDefPhoneNumForeign;
    }
    ...
    public String getSponsDefLocForgnPostalCd() {
        return sponsDefLocForgnPostalCd;
    }

    public void setSponsDefLocForgnPostalCd(String sponsDefLocForgnPostalCd) {
        this.sponsDefLocForgnPostalCd = sponsDefLocForgnPostalCd;
    }
    ...
    public String getSponsDefMailForgnProvSt() {
        return sponsDefMailForgnProvSt;
    }

    public void setSponsDefMailForgnProvSt(String sponsDefMailForgnProvSt) {
        this.sponsDefMailForgnProvSt = sponsDefMailForgnProvSt;
    }
    ...
    public String getPlanDefDate() {
        return planDefDate;
    }

    public void setPlanDefDate(String planDefDate) {
        this.planDefDate = planDefDate;
    }
    ...
    public String getSponsDefLocUSCity() {
        return sponsDefLocUSCity;
    }

    public void setSponsDefLocUSCity(String sponsDefLocUSCity) {
        this.sponsDefLocUSCity = sponsDefLocUSCity;
    }
    ...
    public String getAdminForeignAddress1() {
        return adminForeignAddress1;
    }

    public void setAdminForeignAddress1(String adminForeignAddress1) {
        this.adminForeignAddress1 = adminForeignAddress1;
    }
    ...
    public String getSponsDefMailUsAddress1() {
        return sponsDefMailUsAddress1;
    }

    public void setSponsDefMailUsAddress1(String sponsDefMailUsAddress1) {
        this.sponsDefMailUsAddress1 = sponsDefMailUsAddress1;
    }

    public String getSponsDefLocUsAddress1() {
        return sponsDefLocUsAddress1;
    }

    public void setSponsDefLocUsAddress1(String sponsDefLocUsAddress1) {
        this.sponsDefLocUsAddress1 = sponsDefLocUsAddress1;
    }

    public String getDefManualSignedDate() {
        return defManualSignedDate;
    }

    public void setDefManualSignedDate(String defManualSignedDate) {
        this.defManualSignedDate = defManualSignedDate;
    }
    ...
    public String getSponsDefLocForeignCntry() {
        return sponsDefLocForeignCntry;
    }

    public void setSponsDefLocForeignCntry(String sponsDefLocForeignCntry) {
        this.sponsDefLocForeignCntry = sponsDefLocForeignCntry;
    }

    public String getSponsDefMailUsState() {
        return sponsDefMailUsState;
    }

    public void setSponsDefMailUsState(String sponsDefMailUsState) {
        this.sponsDefMailUsState = sponsDefMailUsState;
    }

    public String getRtdSepPartchFunCnt() {
        return rtdSepPartchFunCnt;
    }

    public void setRtdSepPartchFunCnt(String rtdSepPartchFunCnt) {
        this.rtdSepPartchFunCnt = rtdSepPartchFunCnt;
    }

    public String getComplaineM1FilingReqInd() {
        return complaineM1FilingReqInd;
    }

    public void setComplaineM1FilingReqInd(String complaineM1FilingReqInd) {
        this.complaineM1FilingReqInd = complaineM1FilingReqInd;
    }
    ...
    public String getSponsDefCareOfName() {
        return sponsDefCareOfName;
    }

    public void setSponsDefCareOfName(String sponsDefCareOfName) {
        this.sponsDefCareOfName = sponsDefCareOfName;
    }
    ...
    public String getValidDefSignature() {
        return validDefSignature;
    }

    public void setValidDefSignature(String validDefSignature) {
        this.validDefSignature = validDefSignature;
    }
    ...
    public String getTypePlanEntiyCd() {
        return typePlanEntiyCd;
    }

    public void setTypePlanEntiyCd(String typePlanEntiyCd) {
        this.typePlanEntiyCd = typePlanEntiyCd;
    }

    public String getSponsDefLocForgnProvSt() {
        return sponsDefLocForgnProvSt;
    }

    public void setSponsDefLocForgnProvSt(String sponsDefLocForgnProvSt) {
        this.sponsDefLocForgnProvSt = sponsDefLocForgnProvSt;
    }
    ...
    public String getSponsorDefName() {
        return sponsorDefName;
    }

    public void setSponsorDefName(String sponsorDefName) {
        this.sponsorDefName = sponsorDefName;
    }

    public String getSponsDefMailUsAddress2() {
        return sponsDefMailUsAddress2;
    }

    public void setSponsDefMailUsAddress2(String sponsDefMailUsAddress2) {
        this.sponsDefMailUsAddress2 = sponsDefMailUsAddress2;
    }
    ...
    public String getSponsDefLocUSState() {
        return sponsDefLocUSState;
    }

    public void setSponsDefLocUSState(String sponsDefLocUSState) {
        this.sponsDefLocUSState = sponsDefLocUSState;
    }
    ...
    public String getDefManualSignedName() {
        return defManualSignedName;
    }

    public void setDefManualSignedName(String defManualSignedName) {
        this.defManualSignedName = defManualSignedName;
    }

    public String getSponsDefMailForgnPostalCd() {
        return sponsDefMailForgnPostalCd;
    }

    public void setSponsDefMailForgnPostalCd(String sponsDefMailForgnPostalCd) {
        this.sponsDefMailForgnPostalCd = sponsDefMailForgnPostalCd;
    }
    ...
    public String getSponsdefLocForeignCity() {
        return sponsdefLocForeignCity;
    }

    public void setSponsdefLocForeignCity(String sponsdefLocForeignCity) {
        this.sponsdefLocForeignCity = sponsdefLocForeignCity;
    }
    ...
    public String getAdminEin() {
        return adminEin;
    }

    public void setAdminEin(String adminEin) {
        this.adminEin = adminEin;
    }
    ...
    public String getSponsDefMailForeignAddr1() {
        return sponsDefMailForeignAddr1;
    }

    public void setSponsDefMailForeignAddr1(String sponsDefMailForeignAddr1) {
        this.sponsDefMailForeignAddr1 = sponsDefMailForeignAddr1;
    }
    ...
    public String getSponsDefMailForeignCity() {
        return sponsDefMailForeignCity;
    }

    public void setSponsDefMailForeignCity(String sponsDefMailForeignCity) {
        this.sponsDefMailForeignCity = sponsDefMailForeignCity;
    }

    public String getGetSponsDefLocForeignAddress2() {
        return getSponsDefLocForeignAddress2;
    }

    public void setGetSponsDefLocForeignAddress2(String getSponsDefLocForeignAddress2) {
        this.getSponsDefLocForeignAddress2 = getSponsDefLocForeignAddress2;
    }
    ...
    public String getSponsDefLocUsZip() {
        return sponsDefLocUsZip;
    }

    public void setSponsDefLocUsZip(String sponsDefLocUsZip) {
        this.sponsDefLocUsZip = sponsDefLocUsZip;
    }
    ...
    public String getSponsDefDbaName() {
        return sponsDefDbaName;
    }

    public void setSponsDefDbaName(String sponsDefDbaName) {
        this.sponsDefDbaName = sponsDefDbaName;
    }

    public String getSponsDefPhoneNum() {
        return sponsDefPhoneNum;
    }

    public void setSponsDefPhoneNum(String sponsDefPhoneNum) {
        this.sponsDefPhoneNum = sponsDefPhoneNum;
    }

    public String getAdminSignedDate() {
        return adminSignedDate;
    }

    public void setAdminSignedDate(String adminSignedDate) {
    ...
    public String getDefSignedDate() {
        return defSignedDate;
    }

    public void setDefSignedDate(String defSignedDate) {
        this.defSignedDate = defSignedDate;
    }
    ...
    public String getSponsDefLocUsAddress2() {
        return sponsDefLocUsAddress2;
    }

    public void setSponsDefLocUsAddress2(String sponsDefLocUsAddress2) {
        this.sponsDefLocUsAddress2 = sponsDefLocUsAddress2;
    }

    public String getAdminUsZip() {
        return adminUsZip;
    }

    public void setAdminUsZip(String adminUsZip) {
        this.adminUsZip = adminUsZip;
    }
